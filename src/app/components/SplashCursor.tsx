...
/**
 * WebGL fluid cursor trail overlay from React Bits.
 */
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getSupportedFormat(
      ...
      if (!type || !supportRenderTextureFormat(glContext, internalFormat, format, type)) {
        switch (internalFormat) {
          case (glContext as WebGL2RenderingContext).R16F:
            return getSupportedFormat(glContext, (glContext as WebGL2RenderingContext).RG16F, glContext.RG, type);
