...
interface MagicRingsRuntimeProps extends Required<Omit<MagicRingsProps, "className">> {}

/**
 * WebGL concentric magic rings shader background from React Bits.
 */
export default function MagicRings({
  ...
  const containerClassName = ["magic-rings-container", className].filter(Boolean).join(" ");
